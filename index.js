  ...
  */
  ...
  function USApop(array){
    ...
    for(let i = 0; i < array.length; i++) {
      newArray[i] = array[i].population;
    }
   const total = newArray.reduce((previousValue, currentValue) => previousValue + currentValue)
   return total;
  }
...
CuboidMaker.prototype.volume = function () {
  let volume = this.height * this.width * this.length;
  return volume;
}
